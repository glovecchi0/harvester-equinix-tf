...
variable "cluster_network_vlanconfig_name" {
  description = "Name of the Harvester Cluster Network VLAN configuration"
  type        = string
  default     = "cluster-vlan-all-nodes"
}

variable "cluster_network_vlan_nics" {
  description = "List of NICs used for the Harvester Cluster Network VLAN"
  type        = list(any)
  default     = ["enp1s0f1"]
}

variable "network_name" {
  description = "Name of the Harvester VMs Network"
  type        = string
  default     = "vlan1"
}

variable "network_vlan_id" {
  description = "VLAN ID for the Harvester VMs Network"
  type        = number
  default     = 1
}

variable "harvester_namespace" {
  description = "Namespace where Harvester resources are deployed"
  type        = string
  default     = "default"
}
